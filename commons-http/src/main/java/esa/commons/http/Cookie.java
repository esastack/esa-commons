...
public interface Cookie {
    ...
    /**
     * Returns true if the raw value of this {@link Cookie}, was wrapped with double quotes in original Set-Cookie
     * header.
     *
     ...
     * will be automatically removed by browser because it will expire immediately. If {@link Cookie#UNDEFINED_MAX_AGE}
     * is specified, this {@link Cookie} will be removed when the browser is closed.
     *
    ...
    /**
     * Checks to see if this {@link Cookie} can only be accessed via HTTP. If this returns true, the {@link Cookie}
     * cannot be accessed through client side script - But only if the browser supports it. For more information, please
     * look <a href="http://www.owasp.org/index.php/HTTPOnly">here</a>
     *
    ...
    /**
     * Determines if this {@link Cookie} is HTTP only. If set to true, this {@link Cookie} cannot be accessed by a
     * client side script. However, this works only if the browser supports it. For for information, please look
    ...
    /**
     * Encode this cookie as string.
     *
     * @return encoded string
     */
    String encode(boolean isServer);
