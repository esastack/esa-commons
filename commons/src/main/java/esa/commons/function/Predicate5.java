...
public interface Predicate5<T1, T2, T3, T4, T5> {
     ...
     */
    default Predicate5<T1, T2, T3, T4, T5> and(Predicate5<? super T1, ? super T2, ? super T3, ? super T4,
            ? super T5> other) {
     ...
     * @throws NullPointerException if other is null
     */
    default Predicate5<T1, T2, T3, T4, T5> or(Predicate5<? super T1, ? super T2, ? super T3, ? super T4,
            ? super T5> other) {
        Checks.checkNotNull(other);
        return (T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) -> test(t1, t2, t3, t4, t5) || other.test(t1, t2, t3, t4, t5);
    }
